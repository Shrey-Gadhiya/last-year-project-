<!-- php to redirect page after login -->
<?php
session_start();
  ...
  <div class="container-fluid" style="margin: 0;padding: 1;">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
      ...
      <div class="offcanvas-body">
       ...
       <section class="vh-100 bg-image" style="background-color: #f34077;">
             ...
             <div class="col-12 col-md-9 col-lg-7 col-xl-6">
               <div class="card" style="border-radius: 15px;">
                 <div class="card-body p-5">
                   <h2 class="text-uppercase text-center mb-5">LOG IN YOUR ACCOUNT</h2>
     ...
     <div><p>Not registered yet -> <a href="account.php">Register Here</a></p></div>
    </div>
            ...
            <div class="footer-row">
              ...
              <div class="footer-col">
                ...
                <ul class="links">
                  ...
                  <li>ADDRESS :-<a href="#">KATARGAM , SURTA ,GUJRAT</a></li>
